...
gdf_path = '/workspace/AuxData/50001.parquet'
customers_path = '/workspace/AuxData/customers.parquet'
employees_path = '/workspace/AuxData/employees.parquet'
neighborhood_path ='/workspace/AuxData/medellin_neighborhoods.parquet'
